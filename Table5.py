...
for prs in range(n_vintage):
    ...
    #if(int(ym%100)<10):
        #r_q = "0" + str(int(ym%100)) + "_" + str(q)
        #print(r_q)
    #else:
        #r_q = str(int(ym%100)) + "_" + str(q)
        #print(r_q)
    ...
    class BASE_RNN():
        ...
        def __init__(self,  EMB_DIM = 16,
            ...
            self.TRAIN_FILE = "../Replication_IJF/data/" + INPUT_FILE + "/train_all_dtsm_x_forecast_Deli_random_debug0.txt"
            self.TEST_FILE = "../Replication_IJF/data/" + INPUT_FILE + "/test_all_dtsm_x_forecast_Deli_random_debug0.txt"
    ...
    if(prs<48):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/Replication_IJF/saved_model/model_forecast_washout40_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/Replication_IJF/saved_model/model_forecast_washout40_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    else:
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/Replication_IJF/saved_model/model16to21_gpu2_forecast_washout40_nodeli_random data_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/Replication_IJF/saved_model/model16to21_gpu2_forecast_washout40_nodeli_random data_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    step = 100000
    ...
    #print('RUNNING_MODEL.BATCH_SIZE',RUNNING_MODEL.BATCH_SIZE)        
    ...
    llr_test_washout = -mean_loss*count 
    ...
    unbalanced_log_likeli_lstm_washout = 0
    for i in range(len(unbalanced_prediction)):
        if(true_label[i][0] == 1.0):
            unbalanced_log_likeli_lstm_washout = unbalanced_log_likeli_lstm_washout + math.log(1-unbalanced_prediction[i])
        else:
            unbalanced_log_likeli_lstm_washout = unbalanced_log_likeli_lstm_washout + math.log(unbalanced_prediction[i])
    ...
    #print('Unbalanced LLR: ',(-unbalanced_log_likeli_lstm_washout)/len(unbalanced_prediction))

    #for log_likelihoo_ratio test
    llr_test_unbalanced_lstm_washout = unbalanced_log_likeli_lstm_washout 
    ...
    for m in range(len(time_window)): 
        ...
        for i in range(len(seqlen2)):
            ...
            if(seqlen2[i] <= time_window[m]):
                #1
                predict = unbalanced_prediction_lstm_washout[id:id+int(seqlen2[i])]
                h0 = predict[0]
                survival = 1-h0
            ...
            #max_age > time_window
                ...
                predict = unbalanced_prediction_lstm_washout[id:int(id+time_window[m])]
                h0 = predict[0]
                survival = 1-h0
                for j in range(1,len(predict)):
                    survival = survival*(1-predict[j])
    ...
    #print('time window 36,60,120==============================')
    #time dependent AUC
    is_default = 0
    #set the time windows:
    time_window = [36,60,120]
    ...
    class BASE_RNN():
        ...
        def load(self, meta, ckpt, step):
            ...
            #return sess #general case for loading model
            return AUC24
    ...
    ##lstm washout attention testing
    #if(int(ym%100)<10):
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #TEST_FILE = new_path + "/Replication_IJF/data/2259/" + "test" + "0" + str(int(ym%100)) + "_" + str(q) + "_unbalanced_dtsm_x_Deli.txt"
    ...
    #RUNNING_MODEL.test_data_win = SparseData(TEST_FILE, True, False,1, 512)
        ...
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_washout40_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_washout40_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #else:
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJF/saved_model/model16to21_gpu5_forecast_washout40_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJF/saved_model/model16to21_gpu5_forecast_washout40_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #step = 100000
    ...
    #RUNNING_MODEL.test_data_win = SparseData(TEST_FILE, True, False,1, 512)
        ...
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_washout40_deli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_washout40_deli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #else:
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJF/saved_model/model16to21_gpu5_forecast_washout40_deli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJF/saved_model/model16to21_gpu5_forecast_washout40_deli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #step = 100000
        ...
        def __init__(self, INPUT_FILE, win, all,discount,fixed_batch_size):
            ...
            for i in range(len(self.load_data)):
                ...
                if(str(new_seq) != str(last_seq)):
                    ...
                    t_indices2.append(s[8])
                    t_indices2.append(s[9])
                    #lstm nowashout attention scaler
                    t_indices2.append(self.vt.transform([int(s[13])])[0])
                    #t_indices2.append(self.vt.transform([201304])[0])

                    #exclude account only has one row(month 0)
                    if((max_seqlen+1 != (len(current_deli)-1)) or (max_seqlen == 0)):
                    #if(max_seqlen+1 != (len(current_deli)-1)):
                        is_break = 1
                        #print('max_seqlen+1:',max_seqlen+1)
    ...
    class BASE_RNN():
        ...
        def __init__(self,  EMB_DIM = 16,
            ...
            self.SAVE_LOG = SAVE_LOG
            self.TRAIN_FILE = "../Replication_IJF/data/" + INPUT_FILE + "/train_all_dtsm_x_forecast_Deli_random_debug0.txt"
            self.TEST_FILE = "../Replication_IJF/data/" + INPUT_FILE + "/train_all_dtsm_x_forecast_Deli_random_debug0.txt"
            self.OPEN_TEST = OPEN_TEST
            self.COV_SIZE = COV_SIZE
            self.SHOW_SURVIVAL_CURVE = False
            self.W_attention = W_attention
        ...
        def load(self, meta, ckpt, step):
            ...
            #for log_likelihoo_ratio test
            llr_test_nowashout_attention = -mean_loss*count 
            ...
            unbalanced_log_likeli_nowashout_attention = 0
            for i in range(len(unbalanced_prediction)):
                if(true_label[i][0] == 1.0):
                    unbalanced_log_likeli_nowashout_attention = unbalanced_log_likeli_nowashout_attention + math.log(1-unbalanced_prediction[i])
                else:
                    unbalanced_log_likeli_nowashout_attention = unbalanced_log_likeli_nowashout_attention + math.log(unbalanced_prediction[i])
            ...
            #delete mean_auc for a moment
            #print("TEST DATA LOSS:",mean_loss)
            #print('Unbalanced LLR: ',(-unbalanced_log_likeli_nowashout_attention)/len(unbalanced_prediction))

            #for log_likelihoo_ratio test
            llr_test_unbalanced_nowashout_attention = unbalanced_log_likeli_nowashout_attention 
            ...
            unbalanced_prediction_nowashout_attention = unbalanced_prediction
            ...
            for m in range(len(time_window)): 
                ...
                for i in range(len(seqlen2)):
                    ...
                    if(seqlen2[i] <= time_window[m]):
                        #1
                        predict = unbalanced_prediction_nowashout_attention[id:id+int(seqlen2[i])]
                        h0 = predict[0]
                        survival = 1-h0
                        for j in range(1,len(predict)):
                            survival = survival*(1-predict[j])
                    ...
                    #max_age > time_window
                        ...
                        predict = unbalanced_prediction_nowashout_attention[id:int(id+time_window[m])]
                        h0 = predict[0]
                        survival = 1-h0
                        for j in range(1,len(predict)):
                            survival = survival*(1-predict[j])
            ...
            brier_score = 0
            for i in range(len(unbalanced_prediction_nowashout_attention)):
                brier_score = brier_score + (unbalanced_prediction_nowashout_attention[i]-int(true_label[i][1]))**2
            #print('nowashout_attention brier score: ',brier_score/len(unbalanced_prediction_nowashout_attention))
            #return sess #general case for loading model
            return AUC24
    ...
    ##lstm nowashout attention testing
    #if(int(ym%100)<10):
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #TEST_FILE = new_path + "/Replication_IJF/data/2259/" + "test" + "0" + str(int(ym%100)) + "_" + str(q) + "_unbalanced_dtsm_x_Deli.txt"
    ...
    #RUNNING_MODEL.test_data_win = SparseData(TEST_FILE, True, False,1, 512)
        ...
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_nowashout_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJF/saved_model/model04to12_gpu_forecast_nowashout_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #else:
        #path = os.getcwd()
        #new_path = path.replace("\\","/")
        #meta = new_path + "/Replication_IJ/saved_model/model16to21_gpu_forecast_nowashout_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        #ckpt = new_path + "/Replication_IJ/saved_model/model16to21_gpu_forecast_nowashout_nodeli_random data_attention seq selfdot_noL2_512_16_exclude_exception" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    #step = 100000


    #pseudo_nowashout_attention.append(RUNNING_MODEL.load(meta,ckpt,step))
    


    

    #To run the code automatically,cumulative months and quarters 
    if((q+1)<=4):
        q = q + 1
    else:
        q = 1
    ...
    #if(prs > 47):
        #index_g = prs - 48
    #print('AUC for each model in this round.')
    #print('As can be seen, our proposed model"3LSTM+attn+wo+deli" performs best most of the time.')
    #print("LSTM+wo|","LSTM+attn+wo|","LSTM+attn|","LSTM+attn+wo+deli|","3LSTM+attn+wo+deli|")
    #print(f"{(pseudo_washout[index_g]):.5f}","|",f"{(pseudo_washout_attention[index_g]):.5f}","|",f"{(pseudo_nowashout_attention[index_g]):.5f}","|",f"{(pseudo_attention_deli[index_g]):.5f}","|",f"{(pseudo_3lstm_attention_deli[index_g]):.5f}")
        ...
        #plt.plot(x_axis,pseudo_washout,'blue',label='LSTM+wo',)
        #plt.plot(x_axis,pseudo_washout_attention,'red',label='LSTM+attn+wo',linestyle='--')
        #plt.plot(x_axis,pseudo_nowashout_attention,'grey',label='LSTM+attn' )
        #plt.plot(x_axis,pseudo_attention_deli,'green',label='LSTM+attn+wo+deli')
        #plt.plot(x_axis,pseudo_3lstm_attention_deli,'black',label='3LSTM+attn+wo+deli',linewidth=2)
...
class DelongTest():
    def __init__(self,preds1,preds2,label,vuong,threshold=0.05):
        '''
    ...
    def _show_result(self):
        ...
        #print(f"{z:.5f}",f"{p:.5f}",self._vuong,sep='\t')
        print(self._vuong,p,z,sep='\t')
        if p < self.threshold :print("There is a significant difference")
        else:        print("There is NO significant difference")
            
#print('=========================================')

##washout 3LSTM based attention deli vs lstm washout
#print('LLR washout 3LSTM based attention deli vs lstm washout:')
##LLR Vuong Test
#import math
#llr_dif = []
#llr1 = []
...
#for i in range(len(seqlen2)):
    #if(true_label[i][0] == 1.0):
        #llr1.append(math.log(1-unbalanced_prediction_3lstm_attention_deli[i]))
    #else:
        #llr1.append(math.log(unbalanced_prediction_3lstm_attention_deli[i]))
        
#for i in range(len(seqlen2)):
    #if(true_label[i][0] == 1.0):
        #llr2.append(math.log(1-unbalanced_prediction_lstm_washout[i]))
    #else:
        #llr2.append(math.log(unbalanced_prediction_lstm_washout[i]))

#for i in range(len(seqlen2)):
    #llr_dif.append(llr1[i]-llr2[i])
#llr_dif = np.array(llr_dif)
#m_avg = llr_dif.mean()
#sm_sum = 0
#for i in range(len(seqlen2)):
    #sm_sum += (llr_dif[i]-m_avg)**2
#sm = (sm_sum/len(seqlen2))**(1/2)
#V = (np.sqrt(len(seqlen2))*m_avg)/sm

#print('Vuong Test: ',V)
#DelongTest(unbalanced_prediction_3lstm_attention_deli,unbalanced_prediction_lstm_washout,label_true,V)
...
path = os.getcwd()
new_path = path.replace("\\","/")
csvFile = open(new_path + "/Replication_IJF/data/2259/statistical_test.csv", "r",encoding='gb18030', errors='ignore')
