...
for prs in range(1):
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    csvFile = open(new_path + "/data/2259/u_fd.csv", "r",encoding='gb18030', errors='ignore')
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f2 = open(new_path + "/data/2259/forecast/lag" + str(int(prs+1)*12) + "_dtsm_test_forecast2224_HPI_UNRATE.txt")
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f1 = open(new_path + "/data/2259/forecast/lag" + str(int(prs+1)*12) + "_dtsm_test_forecast2224_HPI_UNRATE.txt")
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            r_default = np.concatenate((r_default, result[prs_s*4+12:prs_s*4+16,8]))
            pseudo_dtsm = np.concatenate((pseudo_dtsm, result[prs_s*4+12:prs_s*4+16,9]))
        print('============================================================')
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f2 = open(new_path + "/data/2259/lag" + str(int(prs+1)*12) + "_dtsm_train_all16to21_HPI_UNRATE.txt")
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            result = np.array(result)
            pseudo_gam = np.concatenate((pseudo_gam, result[prs_s*4+12:prs_s*4+16,10]))
        print('============================================================')
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f2 = open(new_path + "/data/2259/forecast/continuous16to21_survival_train_account.txt")
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f2 = open(new_path + "/data/2259/forecast/continuous16to21_survival_test_account.txt")
    #f2 = open("./test4_data.txt")
    #f2 = open("./test3.txt")
    #train_data = f1.readline()
    #test_data = f2.readline()
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            result = np.array(result)
            pseudo_cox = np.concatenate((pseudo_cox, result[prs_s*4+12:prs_s*4+16,11]))
        print('============================================================')
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            result = np.array(result)
            pseudo_weibull = np.concatenate((pseudo_weibull, result[prs_s*4+12:prs_s*4+16,12]))
        print('============================================================')
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    f2 = open(new_path + "/data/2259/forecast/lag" + str(int(prs+1)*12) + "_dtsm_train_all16to21_HPI_UNRATE.txt")
    ...
    class BASE_RNN():
        ...
        def save_model(self):
            ...
            self.saver.save(self.sess, "D:/saved_model/model16to21_DeepHit_gpu_forecast_deli_noL2_512_16_exclude_exception/" + self.filename, global_step=self.global_step)
    ...
    #LSTM+Deli
    #lagged 12
    #process for the dataset of the time from 2016 to 2024
    #case for delinquency, delete the account that don't start from 0 month.
    #all data
    #f2 = open("./train_all_dtsm_x.txt")
    from sklearn import preprocessing
    ...
    path = os.getcwd()
    new_path = path.replace("\\","/")
    TEST_FILE = new_path + "/data/2259/forecast/lag" + str(int(prs+1)*12) + "_dtsm_test_forecast2224_HPI_UNRATE.txt"
    RUNNING_MODEL.test_data_win = SparseData(TEST_FILE, True, False,1, 512) 

    if(prs == 0):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_DeepHit_lag12_gpu_forecast_deli_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_DeepHit_lag12_gpu_forecast_deli_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 1):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_DeepHit_lag24_gpu_forecast_deli_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_DeepHit_lag24_gpu_forecast_deli_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 2):
        path = os.getcwd()
        new_path = path.replace("\\","/")
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            result = np.array(result)
            pseudo_deephit = np.concatenate((pseudo_deephit, result[prs_s*4+12:prs_s*4+16,13]))
        print('============================================================')        
    ...
    if(prs == 0):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag12_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag12_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 1):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag24_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag24_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 2):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag36_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag36_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    step = 100000
    ...
    if(exposure):
        ...
        for prs_s in range(3):
            ...
            result = np.array(result)
            pseudo_3lstm = np.concatenate((pseudo_3lstm, result[prs_s*4+12:prs_s*4+16,14]))
        print('============================================================')
    ...
    if(prs == 0):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag12_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag12_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 1):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag24_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag24_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    if(prs == 2):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/saved_model/model16to21_lag36_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1.meta"
        ckpt = new_path + "/saved_model/model16to21_lag36_gpu_forecast_washout40_deli_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1"
    step = 100000
    ...
    if(exposure):
        ...
        for prs_s in range(3):    
            ...
            result = np.array(result)
            pseudo_lstm = np.concatenate((pseudo_lstm, result[prs_s*4+12:prs_s*4+16,15]))
        print('============================================================')
...
x_axis = []
hr = []
print('The results for Figure 20 have been generated and saved in the output folder.')
...
plt.plot(x_axis,pseudo_deephit.astype(float),'black',label='DeepHit')
...
path = os.getcwd()
new_path = path.replace("\\","/")
plt.savefig(new_path + "/output/Figure20.png")
#plt.show() 
