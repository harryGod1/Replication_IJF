...
for prs in range(0,3):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/dtsm_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/gam_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/cox_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/weibull_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/deephit_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/3lstm_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/lstm_forecast_default(22to24).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
...
x_axis = []
hr = []
print('Forecasts of default rate(2022-2024): ')
...
plt.title('Forecasts of default rate(2022-2024)')
plt.xlabel('Time')
plt.show() 