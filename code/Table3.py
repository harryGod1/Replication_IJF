...
class SparseData():
    ...
    def __init__(self, INPUT_FILE, win, all,discount,fixed_batch_size):
        ...
        self.vt.fit([201401,201402,201403,201404,201501,201502,201503,201504,201601,201602,201603,201604,201701,201702,201703,201704,201801,
        ...
        for i in range(len(self.load_data)):
            ...
            if(s[3] != 999):# added at 2024/12/22, for processing th missing value of DTI
                ...
                if(str(new_seq) == str(last_seq) and len_count > max_seqlen + 1):
                    ...
                    #t_indices2.append(self.vt.transform([201301])[0])
        ...
        os_i = 0
        os_s = 0
        #print('self.data4:',self.data4[0])
        for i in range(len(self.data4)):
            if(str(self.data4[i][0]) != '9' and self.data4[i][0] == 'P'):
                #print(self.data3[i][5])
                os_p = os_p + 1
            if(str(self.data4[i][0]) != '9' and self.data4[i][0] == 'I'):
                os_i = os_i + 1
            if(str(self.data4[i][0]) != '9' and self.data4[i][0] == 'S'):
                os_s = os_s + 1
        ...
        pt_cp = 0
        for i in range(len(self.data4)):
            if(str(self.data4[i][1]) != '9' and str(self.data4[i][1]) == 'PU'):
                #print(self.data3[i][5])
                pt_pu = pt_pu + 1
            if(str(self.data4[i][1]) != '9' and str(self.data4[i][1]) == 'SF'):
                pt_sf = pt_sf + 1
            if(str(self.data4[i][1]) != '9' and str(self.data4[i][1]) == 'CO'):
                pt_co = pt_co + 1
            if(str(self.data4[i][1]) != '9' and str(self.data4[i][1]) == 'MH'):
                pt_mh = pt_mh + 1
            if(str(self.data4[i][1]) != '9' and str(self.data4[i][1]) == 'CP'):
                pt_cp = pt_cp + 1
        ...
        for i in range(len(self.data4)):
            if(str(self.data4[i][2]) != '9' and str(self.data4[i][2]) == 'P'):
                
                lp_p = lp_p + 1
            if(str(self.data4[i][2]) != '9' and str(self.data4[i][2]) == 'C'):
                lp_c = lp_c + 1
            if(str(self.data4[i][2]) != '9' and str(self.data4[i][2]) == 'N'):
                lp_n = lp_n + 1
            if(str(self.data4[i][2]) != '9' and str(self.data4[i][2]) == 'R'):
                lp_r = lp_r + 1
    ...
    def next(self, batch_size):
        ...
        avg_transaction = 0
        for i in range(len(self.seqlen)):
            avg_transaction = avg_transaction + self.seqlen[i] - 40
        
        
        default_account = 0
        for i in range(len(self.labels)):
            if(self.labels[i][1] == 1.):
                default_account = default_account + 1
        ...
        for i in range(len(self.data3)):
            if(int(self.data3[i][0]) != 9999):
                #print(self.data3[i][0])
                credit_score.append(self.data3[i][0])
        ...
        dti = []
        for i in range(len(self.data3)):
            if(int(self.data3[i][1]) != 999):
                #print(self.data3[i][1])
                dti.append(self.data3[i][1])
        ...
        upb = []
        for i in range(len(self.data3)):
            if(int(self.data3[i][2]) != 999):
                #print(self.data3[i][2])
                upb.append(self.data3[i][2])
        ...
        ltv = []
        for i in range(len(self.data3)):
            if(int(self.data3[i][3]) != 999):
                #print(self.data3[i][3])
                ltv.append(self.data3[i][3])
        ...
        ir = []
        for i in range(len(self.data3)):
            if(int(self.data3[i][4]) != 999):
                #print(self.data3[i][4])
                ir.append(self.data3[i][4])
        ...
        nb_2 = 0
        for i in range(len(self.data3)):
            if(int(self.data3[i][5]) != 99 and int(self.data3[i][5]) == 0):
                #print(self.data3[i][5])
                nb_1 = nb_1 + 1
            if(int(self.data3[i][5]) != 99 and int(self.data3[i][5]) == 1):
                nb_2 = nb_2 + 1
        ...
        deli_2 = 0
        deli_3p = 0
        for i in range(len(self.deli2)):
            if(self.deli2[i] != 'XX' and int(self.deli2[i]) == 0):
                #print(self.data3[i][5])
                deli_0 = deli_0 + 1
            if(self.deli2[i] != 'XX' and int(self.deli2[i]) == 1):
                deli_1 = deli_1 + 1
            if(self.deli2[i] != 'XX' and int(self.deli2[i]) == 2):
                deli_2 = deli_2 + 1
            if(self.deli2[i] != 'XX' and int(self.deli2[i]) >= 3):
                deli_3p = deli_3p + 1
        ...
        print('=============================================================')
        print("Bumeric Variables: ","Mean ","Median ","Std. Dev.")
        print('-------------------------------------------------------------')
        print('Credit Risk: ',f"{(statistics.mean(credit_score)):.2f}"," ",f"{(statistics.median(credit_score)):.2f}"," ",f"{(statistics.stdev(credit_score)):.2f}" )
        print('Debt to Income: ',f"{(statistics.mean(dti)):.2f}"," ",f"{(statistics.median(dti)):.2f}"," ",f"{(statistics.stdev(dti)):.2f}")
        print('Unpaid principle balance: ',f"{(statistics.mean(upb)):.2f}"," ",f"{(statistics.median(upb)):.2f}"," ",f"{(statistics.stdev(upb)):.2f}")
        print('Loan to value: ',f"{(statistics.mean(ltv)):.2f}"," ",f"{(statistics.median(ltv)):.2f}"," ",f"{(statistics.stdev(ltv)):.2f}")
        print('Interest Rate: ',f"{(statistics.mean(ir)):.2f}"," ",f"{(statistics.median(ir)):.2f}"," ",f"{(statistics.stdev(ir)):.2f}")
        print('=============================================================')
        print("Categorical Variables: ","Categories (%) ")
        print('-------------------------------------------------------------')
        print('Number of \n borrowers: ',"1 Borrower"," ","More than 1 borrower" )
        print("             ",f"{(nb_1/len(self.data3)*100):.2f}%"," ",f"{(nb_2/len(self.data3)*100):.2f}%","")
        print('Occupancy Status: ',"PR"," ","IP"," ","SH" )
        print("             ",f"{(self.os_p/len(self.data4)*100):.2f}%"," ",f"{(self.os_i/len(self.data4)*100):.2f}%"," ",f"{(self.os_s/len(self.data4)*100):.2f}%")
        print('Property Type: ',"SF"," ","PUD"," ","Condo"," ","MH"," ","CS" )
        print("             ",f"{(self.pt_pu/len(self.data4)*100):.2f}%"," ",f"{(self.pt_sf/len(self.data4)*100):.2f}%"," ",f"{(self.pt_co/len(self.data4)*100):.2f}%"," ",f"{(self.pt_mh/len(self.data4)*100):.2f}%"," ",f"{(self.pt_cp/len(self.data4)*100):.2f}%")
        print('Loan Purpose: ',"P"," ","CO"," ","NCO" )
        print("             ",f"{(self.lp_p/len(self.data4)*100):.2f}%"," ",f"{(self.lp_c/len(self.data4)*100):.2f}%"," ",f"{(self.lp_n/len(self.data4)*100):.2f}%")
        print('Delinquency Status: ',"0"," ","1"," ","2" )
        print("             ",f"{(deli_0/len(self.deli2)*100):.2f}%"," ",f"{(deli_1/len(self.deli2)*100):.2f}%"," ",f"{(deli_2/len(self.deli2)*100):.2f}%")
        print('=============================================================')
...
f1 = open(new_path + "/Replication_IJF/data/2259/train16to21_all_dtsm_x_forecast_Deli_random_debug0.txt")
...
while train_data:
    ...
    if(int(line_data[0])!=9999 ):
        ...
        #train_FTHF.append(str(line_data[1]))
        train_OS.append(str(line_data[2]))
        train_DTI.append(int(line_data[3]));
        train_UPB.append(int(line_data[4]));
        train_LTV.append(int(line_data[5]));
        train_IR.append(float(line_data[6]));
        #train_Channel.append(str(line_data[7]));
        train_PT.append(str(line_data[8]));
        train_LP.append(str(line_data[9]));
        train_NB.append(int(line_data[10]));
        train_SEQ.append(str(line_data[11]));
        #train_Age.append(int(line_data[12]));
        #train_vintage.append(int(vintage));
        #train_calendar.append((int(int(vintage)/100)-2004)*12 + (int(vintage)%100 - 1)*3 + int(line_data[12]));
        #train_Def.append(int(line_data[14]));
    train_data = f1.readline();
...
path = os.getcwd()
new_path = path.replace("\\","/")
TEST_FILE = new_path + "/Replication_IJF/data/2259" + "/train_test16to21_all_dtsm_x_forecast_Deli_random_debug0.txt"
