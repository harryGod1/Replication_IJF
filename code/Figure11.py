...
for prs in range(n_vintage):
    ...
    if(prs<48):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        f2 = open(new_path + "/data/2259/continuous_survival_train_account.txt")
    else:    
        path = os.getcwd()
        new_path = path.replace("\\","/")
        f2 = open(new_path + "/data/2259/continuous16to21_survival_train_account.txt")
    ...
    if(prs<48):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        f2 = open(new_path + "/data/2259/continuous_survival_test_account.txt")
    else:
        path = os.getcwd()
        new_path = path.replace("\\","/")
        f2 = open(new_path + "/data/2259/continuous16to21_survival_test_account.txt")
    #f2 = open("./test4_data.txt")
    #f2 = open("./test3.txt")
    #train_data = f1.readline()
    #test_data = f2.readline()
   ...
   # print('time window 24,36,60==============================')
    ...
    class BASE_RNN():
        ...
        def load(self, meta, ckpt, step):
            ...
            return pseudo_r #specific testing
...
pseudo_gam = df.iloc[2:36,4]
pseudo_cox = df.iloc[2:36,6]
pseudo_weibull = df.iloc[2:36,8]
pseudo_deephit = df.iloc[2:36,10]
pseudo_3lstm = df.iloc[2:36,12]
