...
for prs in range(0,3):
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #r_default.append(count_default/count_within_lag*100)
            #pseudo_dtsm.append(predicted_default/count_within_lag*100)
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/dtsm_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_gam.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/gam_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    if(is_exposure_wb):
        ...
        for i in range(len(seqlen)):
            unconditional_pd = 1
            for j in range(seqlen[i]-1):
                unconditional_pd = unconditional_pd * (1 - unbalanced_prediction_wb[id+j])
            unconditional_pd = unconditional_pd * unbalanced_prediction_wb[id+seqlen[i]-1]
            ead = x2[id+seqlen[i]-1][3]*((1-((1+x2[id+seqlen[i]-1][5])**(1/12))**(j-x2[id+seqlen[i]-1][8]))/(1-((1+x2[id+seqlen[i]-1][5])**(1/12))**(-x2[id+seqlen[i]-1][8])))
        ...
        wb_exposure = expected_all/len(seqlen)
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_cox.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/cox_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_weibull.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/weibull_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_deephit.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/deephit_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    if(prs == 1):
        path = os.getcwd()
        new_path = path.replace("\\","/")
        meta = new_path + "/Replication_IJF/saved_model/model04to12_lag24_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1-8200.meta"
        ckpt = new_path + "/Replication_IJF/saved_model/model04to12_lag24_gpu_forecast_washout40_deli_random_3LSTM_attention seq selfdot_noL2_512_16" + "/drsa32_512_16_0.000100_0.100000_2259_1.20_0.20_True_False_1_1-8200"
    if(prs == 2):
        path = os.getcwd()
        new_path = path.replace("\\","/")
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_3lstm.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/3lstm_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
    ...
    #有些账户比如从4月份开始，如果上一笔帐号最大月份小于4月份（比如是3月份），如果没有这个判断，max seqlen就会从正确的3变成错误的4
                if(str(new_seq) == str(last_seq) and int(s[slen-5]) > max_seqlen):
                    max_seqlen = int(s[slen-5])
    ...
    for i in range(lag_time):
        ...
        ############################################################################
            ...
            #pseudo_lstm.append(predicted_default/count_within_lag*100)
            #print('True default rate: ', count_default/count_within_lag*100)
            #print('Predicted default rate: ', predicted_default/count_within_lag*100)
            #print('============================================================')
        #if(prs == 1 and i>=4 and i < 8):
    ...
    csvFile = open(new_path + "/Replication_IJF/data/2259/lstm_forecast_default(13to15).csv", "r",encoding='gb18030', errors='ignore')
    reader = csv.reader(csvFile)
...
plt.title('Forecasts of default rate(2013-2015)')
plt.xlabel('Time')
plt.show() 